...
public class SimpleForwardSizeKUsingArrayList extends SubgraphEnumerationAlgorithmUsingArrayList{
	
	private ArrayList<Integer> temp = new ArrayList();

	public SimpleForwardSizeKUsingArrayList(ArrayList<Integer>[] g, ArrayList<ArrayList<Integer>> cs, int cardinality, int s, long maximalTime,
			String path) {
		graph = g;
		components = cs;
		k = cardinality;
	...
	public  void enumerate() {
		 ...
		 while(i.hasNext()) {
			   ...
			   // store the exclusive neighbors of the subgraph
