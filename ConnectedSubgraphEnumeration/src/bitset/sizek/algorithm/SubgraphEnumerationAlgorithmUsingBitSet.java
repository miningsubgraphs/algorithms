...
public abstract class SubgraphEnumerationAlgorithmUsingBitSet {
	protected int size = 0; // define the size of the given graph
	protected BitSet[] graph; // the matrix representation of the given graph
	protected ArrayList<BitSet> components;// the connected components in the graph
